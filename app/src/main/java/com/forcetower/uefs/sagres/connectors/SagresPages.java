package com.forcetower.uefs.sagres.connectors;
...
public class SagresPages {
    ...
    public static Document login(String username, String password) {
        ...
        try {
            ...
            Log.i(APP_TAG, "Connection failed at login");
            e.printStackTrace();
        }
    ...
    public static Document getStudentPage() {
    ...
    public static Document getGradesPage() {
        Request request = new Request.Builder()
